    ...
    args = {
        ...
        Audio = {
            ...
            args = {
                ...
                PlayProgressAt50Percent = {
                    type = "toggle",
                    order = 7,
                    width = 2,
                    name = "Play Progress at 50%",
                    desc = "Automatically plays quest progress audio when approximately 50% of objectives are completed.",
                    get = function(info) return Addon.db.profile.Audio.PlayProgressAt50Percent end,
                    set = function(info, value)
                        Addon.db.profile.Audio.PlayProgressAt50Percent = value
                    end,
                },
                PlayTips = {
                    type = "toggle",
                    order = 8,
                    width = 2,
                    name = "Play Audio Tips",
                    desc = "Play random audio tips after completing quests.",
                    get = function(info) return Addon.db.profile.Audio.PlayTips end,
                    set = function(info, value)
                        Addon.db.profile.Audio.PlayTips = value
                    end,
                },
                ResetQuestProgressOnReload = {
                    type = "toggle",
                    order = 9,
                    width = 2,
                    name = "Reset Progress on Reload",
                    desc = "Allows quest progress audio to play again when you reload the interface or restart the game.",
                    get = function(info) return Addon.db.profile.Audio.ResetQuestProgressOnReload end,
                    set = function(info, value)
                        Addon.db.profile.Audio.ResetQuestProgressOnReload = value
                    end,
                },
            }
        },
...
local AboutTab =
{
    ...
    args = {
        ...
        AboutDescription = {
            ...
            order = 2,
            fontSize = "medium",
            name = "Este addon proporciona narración de voz para misiones y diálogos en World of Warcraft.\n\n¡Necesitamos tu apoyo para seguir mejorando y avanzando en el proyecto!",
        },
        SocialHeader = {
            type = "header",
            order = 3,
            name = "Redes Sociales y Soporte",
        },
        DiscordInfo = {
            type = "description",
            order = 4,
            fontSize = "medium",
            name = "|cFF7289DAÚnete a nuestro Discord para más información y soporte:|r",
        },
        DiscordLink = {
            type = "input",
            order = 5,
            width = "full",
            name = "",
            get = function() return "https://discord.gg/jHPsF2dt9y" end,
            set = function() end,
        },
        PatreonInfo = {
            type = "description",
            order = 6,
            fontSize = "medium",
            name = "Para crear estos sonidos de alta calidad, apóyanos en Patreon:",
        },
        PatreonLink = {
            type = "input",
            order = 7,
            width = "full",
            name = "",
            get = function() return "https://www.patreon.com/NeoAuras" end,
            set = function() end,
        },
        YouTubeInfo = {
            type = "description",
            order = 8,
            fontSize = "medium",
            name = "Visita nuestro canal de YouTube para demostraciones:",
        },
        YouTubeLink = {
            type = "input",
            order = 9,
            width = "full",
            name = "",
            get = function() return "https://www.youtube.com/@NeoLabs7" end,
            set = function() end,
        },
        CreditsHeader = {
            type = "header",
        ...
        CreditsInfo = {
            ...
            order = 11,
            fontSize = "medium",
            name = "Modificado por |cFF00FF00mDarkneo|r para TurtleLatam",
        },
    },
}
